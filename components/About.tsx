        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="text-slate-300 space-y-4 text-lg leading-relaxed">
               ...
               */}
              <p>
                Olá! Sou o <strong>{profile.name}</strong>, um desenvolvedor apaixonado por tecnologia sediado em {profile.location}. 
                Minha jornada na programação começou em 2015 e, desde então, tenho me dedicado a transformar conceitos abstratos em interfaces digitais funcionais e atraentes.
              </p>
              <p>
                Tenho um forte background em <strong>Desenvolvimento Front-End</strong>, criando experiências web responsivas e acessíveis. 
                Além disso, minha criatividade flui através do <strong>Game Design</strong>, onde exploro narrativas e mecânicas interativas.
              </p>
              <p>
                Recentemente, tenho mergulhado no universo da <strong>Inteligência Artificial</strong>, buscando formas inovadoras de integrar IA em aplicações web para resolver problemas complexos e automatizar tarefas.
              </p>
            </div>
          </div>
